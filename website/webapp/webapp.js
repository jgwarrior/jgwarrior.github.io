                ...
                setTimeout(function() {
                    ...
                    setTimeout(function() {
                        ...
                        setTimeout(function() {
                            new_message("I don't have time to save all of you though!");
                            setTimeout(function() {
                                document.getElementById("story").innerHTML += "<button onClick='savemore()' id=savemore>Try and save more?";
                                document.getElementById("story").innerHTML += "<button onClick='leaveugandans()' id=leaveugandans> Leave the creatures";
                            }, 10);
                        }, 10);
                    }, 10);
                }, 10);
